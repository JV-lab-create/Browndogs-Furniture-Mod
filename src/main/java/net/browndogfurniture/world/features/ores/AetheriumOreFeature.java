...
public class AetheriumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_furniture:aetherium_ore", FEATURE, new OreConfiguration(AetheriumOreFeatureRuleTest.INSTANCE, BrowndogFurnitureModBlocks.AETHERIUM_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_furniture:aetherium_ore", CONFIGURED_FEATURE,
	...
	private static class AetheriumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<AetheriumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_furniture:aetherium_ore_match"), () -> codec);
