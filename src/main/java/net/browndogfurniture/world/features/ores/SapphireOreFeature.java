...
public class SapphireOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_furniture:sapphire_ore", FEATURE, new OreConfiguration(SapphireOreFeatureRuleTest.INSTANCE, BrowndogFurnitureModBlocks.SAPPHIRE_ORE.defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("browndog_furniture:sapphire_ore", CONFIGURED_FEATURE,
	...
	private static class SapphireOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<SapphireOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_furniture:sapphire_ore_match"), () -> codec);
