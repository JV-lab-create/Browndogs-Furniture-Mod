...
public class TitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("browndog_furniture:titanium_ore", FEATURE, new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, BrowndogFurnitureModBlocks.TITANIUM_ORE.defaultBlockState(), 3));
		PLACED_FEATURE = PlacementUtils.register("browndog_furniture:titanium_ore", CONFIGURED_FEATURE,
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TitaniumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("browndog_furniture:titanium_ore_match"), () -> codec);
